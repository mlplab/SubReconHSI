...
from utils import make_patch, patch_mask, make_patch_list, make_patch_h5py_list
...
save_path = f'../SCI_dataset_tmp/My_{data_name}_{patch_size}'
...
make_fn = {'CAVE': make_patch_list,
           'Harvard': make_patch_list,
           'ICVL': make_patch_h5py_list}
...
make_fn[data_name](data_path, train_list, train_patch_path, size=patch_size,step=patch_step, ch=31, data_key=data_key[data_name])
make_fn[data_name](data_path, test_list, test_patch_path, size=patch_size, step=patch_step, ch=31, data_key=data_key[data_name])
make_fn[data_name](data_path, test_list, eval_path, size=show_size, step=show_step, ch=31, data_key=data_key[data_name])
make_fn[data_name](data_path, test_list, eval_show_path, size=show_size, step=show_step, ch=31, data_key=data_key[data_name])
